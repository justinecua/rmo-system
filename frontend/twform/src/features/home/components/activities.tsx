            ...
            {activities.map((activity) => (
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  <span className="absolute top-4 right-4 bg-gray-900/90 text-white text-xs font-medium px-3 py-1 rounded-full backdrop-blur-sm">
                ...
                <div className="p-5 flex-grow flex flex-col">
                  ...
                  <button
                    ...
                    className="mt-auto w-full bg-gray-50 hover:bg-gray-100 text-gray-800 font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                  >
